...
public sealed class CreateProjectService
{
    ...
    public async Task<Project> CreateAsync(CreateProjectRequest request)
    {
        ...
        var floorplanMetadata = FloorplanMetadataReader.Read(request.FloorplanPath);
        ...
        var floorplanRevision = new FloorplanRevision
        {
            ...
            SourceWidth = floorplanMetadata.Width,
            SourceHeight = floorplanMetadata.Height,
            CreatedAtUtc = now
        };
        ...
        foreach (var imported in importedAnnotations)
        {
            ...
            var annotationRevision = new AnnotationRevision
            {
                ...
                Source = AnnotationRevisionSource.Imported,
